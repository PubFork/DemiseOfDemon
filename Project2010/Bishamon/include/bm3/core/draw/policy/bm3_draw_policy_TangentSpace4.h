#ifndef BM3_SDK_INC_BM3_CORE_DRAW_POLICY_BM3_DRAW_POLICY_TANGENTSPACE4_H
#define BM3_SDK_INC_BM3_CORE_DRAW_POLICY_BM3_DRAW_POLICY_TANGENTSPACE4_H
...
template<>
struct TangentSpace4<DrawRotate::Billboard_Z>{
...
template<>
struct TangentSpace4<DrawRotate::Polyline>{
...
template<>
struct TangentSpace4<DrawRotate::XYZ>{
...
template<>
struct TangentSpace4<DrawRotate::Directional>{
...
template<>
struct TangentSpace4<DrawRotate::DirectionalPolyline>{
...
template<>
struct TangentSpace4<DrawRotate::Facing>{
...
#undef BM3_CORE_DRAW_POLICY_BM3_DRAW_POLICY_TANGENTSPACE4_MakeQuadEdgePos
...
#endif	// #ifndef BM3_SDK_INC_BM3_CORE_DRAW_POLICY_BM3_DRAW_POLICY_TANGENTSPACE4_H
