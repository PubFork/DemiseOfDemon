#ifndef BM3_SDK_INC_BM3_CORE_RESOURCE_BM3_RES_WIND_H
...
/// @brief WindƒNƒ‰ƒX
class Wind : public fileformat::bmb::EffectField_Wind{
};
...
#endif	// #ifndef BM3_SDK_INC_BM3_CORE_RESOURCE_BM3_RES_WIND_H
