#ifndef BM3_SDK_INC_BM3_CORE_MATRIX_BM3_POLICY_RADIALPOWER_MAGNITUDE_CONSTANT_H
#define BM3_SDK_INC_BM3_CORE_MATRIX_BM3_POLICY_RADIALPOWER_MAGNITUDE_CONSTANT_H
...
/// @brief Radialpower_Magnitude_ConstantƒNƒ‰ƒX
class Radialpower_Magnitude_Constant{
...
public:
	...
	static BM3_FORCEINLINE void	Update(UpdateInfo &update_info, const ResourceType &res, float &value){
		if(res.Field_Magnitude_FieldMagnitudeType() == FieldMagnitudeTypeConst_Constant){
			value += res.Field_Magnitude_Initial() * update_info.GetUpdateFrame();
		}
	}
...
#endif	// #ifndef BM3_SDK_INC_BM3_CORE_MATRIX_BM3_POLICY_RADIALPOWER_MAGNITUDE_CONSTANT_H
