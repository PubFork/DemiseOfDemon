#ifndef BM3_SDK_INC_BM3_CORE_MATRIX_BM3_POLICY_WIND_DIRECTION_CONSTANT_H
#define BM3_SDK_INC_BM3_CORE_MATRIX_BM3_POLICY_WIND_DIRECTION_CONSTANT_H
...
/// @brief Wind_Direction_ConstantƒNƒ‰ƒX
class Wind_Direction_Constant{
...
//			direction.random_range(random, res.Field_Direction_Initial(), res.Field_Direction_Range());
...
#endif	// #ifndef BM3_SDK_INC_BM3_CORE_MATRIX_BM3_POLICY_WIND_DIRECTION_CONSTANT_H
