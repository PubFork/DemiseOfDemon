#ifndef BM3_SDK_INC_BM3_CORE_POLICY_CHILDGENERATETIMING_BM3_POLICY_CHILDGENERATETIMING_GENERATENULL_H
#define BM3_SDK_INC_BM3_CORE_POLICY_CHILDGENERATETIMING_BM3_POLICY_CHILDGENERATETIMING_GENERATENULL_H
...
/// @brief ChildGenerateTiming_GenerateNullクラス。ライフを考慮して生成を決める
template<typename LifePolicy>
class ChildGenerateTiming_GenerateNull{
...
public:
	...
	ChildGenerateTiming_GenerateNull(){
		;	
	}
	...
	bool	IsAllChildGenerated(const ResourceType &res, const obj::RootNodeBase &root) const{
		...
		return
			(res.Generate_Basic_GenerateType() == GenerateTypeConst_Constant) ?
				const_.IsAllChildGenerated(res, root, life_) :
				timing_.IsAllChildGenerated(res, root, life_);
	}
...
#endif	// #ifndef BM3_SDK_INC_BM3_CORE_POLICY_CHILDGENERATETIMING_BM3_POLICY_CHILDGENERATETIMING_GENERATENULL_H
