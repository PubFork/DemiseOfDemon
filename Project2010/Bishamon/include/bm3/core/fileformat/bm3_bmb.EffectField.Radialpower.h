...
#ifndef BM3_SDK_INC_BM3_CORE_FILEFORMAT_BMB_EFFECTFIELD_RADIALPOWER_H
#define BM3_SDK_INC_BM3_CORE_FILEFORMAT_BMB_EFFECTFIELD_RADIALPOWER_H
...
struct EffectField_Radialpower{
	...
	BM3_DECLARE_GETTER_VALUE(FieldPositionTypeConst, Field_CenterPosition_FieldPositionType);
	BM3_DECLARE_GETTER_REF(ml::vector3d, Field_CenterPosition_Initial);
	BM3_DECLARE_GETTER_REF(EmbeddedVectorCurveType, Field_CenterPosition_Curve);
	BM3_DECLARE_GETTER_VALUE(FieldInfluenceTypeConst, Field_Influence_FieldInfluenceType);
public:
	int	Mapping(const wchar_t *string_chunk, const void *binary_chunk){
		...
		Field_CenterPosition_Curve_.Mapping(binary_chunk);
...
#endif	// BM3_SDK_INC_BM3_CORE_FILEFORMAT_BMB_EFFECTFIELD_RADIALPOWER_H
