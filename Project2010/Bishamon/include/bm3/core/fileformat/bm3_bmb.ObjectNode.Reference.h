...
#ifndef BM3_SDK_INC_BM3_CORE_FILEFORMAT_BMB_OBJECTNODE_REFERENCE_H
#define BM3_SDK_INC_BM3_CORE_FILEFORMAT_BMB_OBJECTNODE_REFERENCE_H
...
struct ObjectNode_Reference{
	...
	BM3_DECLARE_GETTER_VALUE(ObjectTypeConst, Basic_Basic_ObjectType);
	BM3_DECLARE_GETTER_REF(StringType, Basic_Basic_ReferenceNodeRelativePath);
	BM3_DECLARE_GETTER_REF(StringType, Basic_Basic_ReferenceNodeName);
public:
	int	Mapping(const wchar_t *string_chunk, const void *binary_chunk){
		Basic_Meta_Name_.Mapping(string_chunk);
		Basic_Basic_ReferenceNodeRelativePath_.Mapping(string_chunk);
		Basic_Basic_ReferenceNodeName_.Mapping(string_chunk);
...
#endif	// BM3_SDK_INC_BM3_CORE_FILEFORMAT_BMB_OBJECTNODE_REFERENCE_H
