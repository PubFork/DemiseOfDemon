...
#ifndef BM3_SDK_INC_BM3_CORE_FILEFORMAT_BMB_EFFECTEMITTER_SIMPLEPARTICLE_H
#define BM3_SDK_INC_BM3_CORE_FILEFORMAT_BMB_EFFECTEMITTER_SIMPLEPARTICLE_H
...
struct EffectEmitter_SimpleParticle{
	...
	BM3_DECLARE_GETTER_REF(EmbeddedFloatCurveType, Scale_Value_CurveX);
	BM3_DECLARE_GETTER_VALUE(ml::f32, Scale_Speed_InitialX);
	BM3_DECLARE_GETTER_VALUE(ml::f32, Scale_Speed_RangeX);
	BM3_DECLARE_GETTER_REF(EmbeddedFloatCurveType, Scale_Speed_CurveX);
	BM3_DECLARE_GETTER_VALUE(ml::f32, Scale_Acceleration_InitialX);
	BM3_DECLARE_GETTER_VALUE(ml::f32, Scale_Acceleration_RangeX);
...
public:
	int	Mapping(const wchar_t *string_chunk, const void *binary_chunk){
		...
		Scale_Value_CurveX_.Mapping(binary_chunk);
		Scale_Speed_CurveX_.Mapping(binary_chunk);
...
#endif	// BM3_SDK_INC_BM3_CORE_FILEFORMAT_BMB_EFFECTEMITTER_SIMPLEPARTICLE_H
