...
#ifndef BM3_SDK_INC_BM3_CORE_FILEFORMAT_BMB_EFFECTFIELD_WIND_H
#define BM3_SDK_INC_BM3_CORE_FILEFORMAT_BMB_EFFECTFIELD_WIND_H
...
struct EffectField_Wind{
	...
	BM3_DECLARE_GETTER_REF(ml::vector3d, Field_Area_Initial3d);
	BM3_DECLARE_GETTER_REF(EmbeddedVectorCurveType, Field_Area_Curve3d);
	...
	BM3_DECLARE_GETTER_REF(ml::vector3d, Field_Direction_Range);
...
public:
	int	Mapping(const wchar_t *string_chunk, const void *binary_chunk){
		...
		Field_Area_Curve3d_.Mapping(binary_chunk);
...
#endif	// BM3_SDK_INC_BM3_CORE_FILEFORMAT_BMB_EFFECTFIELD_WIND_H
