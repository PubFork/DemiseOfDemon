...
#ifndef BM3_SDK_INC_BM3_CORE_FILEFORMAT_BMB_EFFECTPROJECT_H
#define BM3_SDK_INC_BM3_CORE_FILEFORMAT_BMB_EFFECTPROJECT_H
...
struct EffectProject{
	...
	BM3_DECLARE_GETTER_REF(ml::vector3d, Basic_Meta_PreviewOffset);
	...
	BM3_DECLARE_GETTER_VALUE(ml::si32, Basic_Basic_RootLife);
	BM3_DECLARE_GETTER_REF(EmbeddedUserDataType, Basic_Basic_UserData);
	BM3_DECLARE_GETTER_VALUE(ml::si32, Basic_Basic_AdvancedFrame);
	BM3_DECLARE_GETTER_VALUE(bool, Basic_Basic_WholeZSort);
	BM3_DECLARE_GETTER_VALUE(bool, Basic_Basic_Version1_5);
	BM3_DECLARE_GETTER_VALUE(bool, Basic_Basic_InterchangedBm2);
public:
...
#endif	// BM3_SDK_INC_BM3_CORE_FILEFORMAT_BMB_EFFECTPROJECT_H
