...
#ifndef BM3_SDK_INC_BM3_CORE_FILEFORMAT_BMB_EFFECTFIELD_VORTEX_H
#define BM3_SDK_INC_BM3_CORE_FILEFORMAT_BMB_EFFECTFIELD_VORTEX_H
...
struct EffectField_Vortex{
	...
	BM3_DECLARE_GETTER_VALUE(FieldAxisTypeConst, Field_Axis_FieldAxisType);
	BM3_DECLARE_GETTER_REF(ml::vector3d, Field_Axis_Initial);
	BM3_DECLARE_GETTER_REF(EmbeddedVectorCurveType, Field_Axis_Curve);
	BM3_DECLARE_GETTER_VALUE(FieldMagnitudeTypeConst, Field_Magnitude_FieldMagnitudeType);
	BM3_DECLARE_GETTER_VALUE(bool, Field_Magnitude_ScaleInfluence);
	BM3_DECLARE_GETTER_VALUE(bool, Field_Magnitude_CentripetalForce);
	...
	BM3_DECLARE_GETTER_VALUE(ml::f32, Field_Magnitude_Damp);
	BM3_DECLARE_GETTER_VALUE(FieldAreaTypeConst, Field_Area_FieldAreaType);
	BM3_DECLARE_GETTER_VALUE(ml::f32, Field_Area_Initial);
	BM3_DECLARE_GETTER_REF(EmbeddedFloatCurveType, Field_Area_Curve);
	BM3_DECLARE_GETTER_VALUE(ml::f32, Field_Option_Noise);
public:
	int	Mapping(const wchar_t *string_chunk, const void *binary_chunk){
		...
		Field_Axis_Curve_.Mapping(binary_chunk);
		Field_Magnitude_Curve_.Mapping(binary_chunk);
		Field_Area_Curve_.Mapping(binary_chunk);
...
#endif	// BM3_SDK_INC_BM3_CORE_FILEFORMAT_BMB_EFFECTFIELD_VORTEX_H
